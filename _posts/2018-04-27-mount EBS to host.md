...
1. 查看当前所有硬盘和大小。
    ...
    效果：
    ![查看所有硬盘](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-04-27-01.jpg){:height="70%" width="70%"}_查看所有可用硬盘_
...
2. 第一次挂载的时候需要对云盘进行格式化，之后挂载就不必格式化了，否则会清除云盘里的所有内容。
    ...
    ![初始化云盘](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-04-27-02.jpg){:height="70%" width="70%"}_初始化云盘_
...
5. 挂载完成是没有提示的，可以通过如下命令查看。
    ...
    ```
    效果：
    ![查看挂载结果](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-04-27-03.jpg){:height="70%" width="70%"}_查看挂载结果_
