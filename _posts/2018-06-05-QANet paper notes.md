...
![QANet 模型结构](assets/images/2018-06-05-01.png)_图 1 QANet 模型结构_
...
![depthwise convolution](assets/images/2018-06-05-02.png){:height="60%" width="60%"}_图 2 depthwise convolution_
...
![pointwise convolution](assets/images/2018-06-05-03.png){:height="60%" width="60%"}_图 3 pointwise convolution_
...
![Attention 机制](assets/images/2018-06-05-04.png){:height="60%" width="60%"}_图 4 Attention 机制_
...
![可视化 self-attention](assets/images/2018-06-05-05.png){:height="60%" width="60%"}_图 5 可视化 self-attention_
...
![residual block 结构](assets/images/2018-06-05-06.png){:height="40%" width="40%"}_图 6 residual block 结构_
