...
![depthwise convolution](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-06-05-02.jpg){:height="60%" width="60%"}_图 2 depthwise convolution_
...
![pointwise convolution](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-06-05-03.jpg){:height="60%" width="60%"}_图 3 pointwise convolution_
...
![Attention 机制](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-06-05-04.jpg){:height="60%" width="60%"}_图 4 Attention 机制_
...
![可视化 self-attention](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-06-05-05.jpg){:height="60%" width="60%"}_图 5 可视化 self-attention_
...
![residual block 结构](https://const-blog.oss-cn-beijing.aliyuncs.com/img/2018-06-05-06.jpg){:height="40%" width="40%"}_图 6 residual block 结构_
